...
public class WpCli 
{
    ...
    public boolean doRewriteRules() throws PHPNotInstalledException, WPCliNotInstalledException
    {
        RewriteCommand cmd = new RewriteCommand(this.context, this.dependency);
